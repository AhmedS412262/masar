...
const makeProfile = (email, name) => ({
  ...
  statusHistory: [
    { label: "تم التسجيل",    date: new Date().toISOString(), done: true  },
    { label: "قيد المراجعة",  date: null, done: false },
    { label: "جاري التحضير", date: null, done: false },
    { label: "اكتمل الملف",  date: null, done: false },
  ],
  notes: "",
  assignedTo: null,
});
